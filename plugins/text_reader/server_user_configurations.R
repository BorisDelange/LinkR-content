                ...
                switch(
                    ...
                    "multiselect" = {
                        if (!is.na(setting_value) && setting_value != "") {
                            ...
                            # Special handling for search_word_sets - update options first
                            if (setting_name == "search_word_sets") {
                                ...
                                shiny.fluent::updateDropdown.shinyInput(session, input_id, options = word_sets, value = as.numeric(variables_vector))
                            } else {
