    ...
    if (indicator == "patient_count") {
        if (indicator_scope == "hospitalization") {
            code_lines <- c(code_lines,
                ...
                "    WHERE visit_start_date >= '\", m$subset_dates[1], \"'",
                "    AND visit_start_date <= '\", m$subset_dates[2], \"'",
                "\"))",
                "",
                "value <- nrow(patients)",
                "",
            ...
            code_lines <- c(code_lines,
                ...
                "    AND visit_detail_start_date >= '\", m$subset_dates[1], \"'",
                "    AND visit_detail_start_date <= '\", m$subset_dates[2], \"'",
                "\"))",
                "",
                "value <- nrow(patients)",
                "",
        ...
        if (indicator_scope == "hospitalization") {
            code_lines <- c(code_lines,
                ...
                "    WHERE v.visit_start_date >= '\", m$subset_dates[1], \"'",
                "    AND v.visit_start_date <= '\", m$subset_dates[2], \"'",
                "\")",
                "",
            ...
            code_lines <- c(code_lines,
                ...
                "    WHERE vd.visit_detail_start_date >= '\", m$subset_dates[1], \"'",
                "    AND vd.visit_detail_start_date <= '\", m$subset_dates[2], \"'",
                "\")",
                "",
                "deaths <- d$con %>% run_query(paste0(\"",
        ...
        if (indicator_scope == "hospitalization") {
            code_lines <- c(code_lines,
                ...
                "    AND visit_start_date >= '\", m$subset_dates[1], \"'",
                "    AND visit_start_date <= '\", m$subset_dates[2], \"'",
                "\"))",
                "",
