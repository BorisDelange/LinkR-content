...
output$settings_files_ui_%widget_id% <- renderUI(try_catch("output$settings_files_ui_%widget_id%", {
...
observeEvent(input$delete_settings_file_%widget_id%, try_catch("", {
